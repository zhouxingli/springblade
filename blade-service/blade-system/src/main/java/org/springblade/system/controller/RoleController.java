...
import org.springblade.system.vo.RoleTableVO;
...
public class RoleController extends BladeController {
	...
	@ApiOperation(value = "授权表", notes = "传入roleId以及menuId集合")
	public R grantTable(@RequestBody RoleTableVO roleTableVO){
		boolean temp=roleService.grantTable(roleTableVO.getRoleId(),roleTableVO.getTableIds());
		return R.status(temp);
	}
