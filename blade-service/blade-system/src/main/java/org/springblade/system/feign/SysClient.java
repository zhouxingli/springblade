...
public class SysClient implements ISysClient {
	...
	@Override
	@GetMapping(API_PREFIX + "/getClientInfo")
	public R<ClientInfo> getClientInfo(String clientId, String clientSecret) {
		return R.data(iAuthClientService.getClientInfo(clientId,clientSecret));
	}
}
