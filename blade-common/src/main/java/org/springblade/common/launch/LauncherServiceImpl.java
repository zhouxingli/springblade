...
public class LauncherServiceImpl implements LauncherService {
	...
	public void launcher(SpringApplicationBuilder builder, String appName, String profile) {
		...
		props.setProperty("spring.cloud.nacos.discovery.namespace", LauncherConstant.NACOS_NAMESPACE);
		props.setProperty("spring.cloud.nacos.discovery.server-addr", LauncherConstant.nacosAddr(profile));
		props.setProperty("spring.cloud.nacos.config.namespace", LauncherConstant.NACOS_NAMESPACE);
		props.setProperty("spring.cloud.nacos.config.server-addr", LauncherConstant.nacosAddr(profile));
		//props.setProperty("spring.cloud.nacos.config.shared-dataids", "rabbitmq.properties");
